...
namespace AddOn\Callout;

class ItreCallout extends \WP_Widget
{
// constructor
    public function __construct()
    {
        ...
        parent::__construct('ItreCallout', 'ITRE Callout', $widget_details);
    }
...
add_action('widgets_init', function () {
    register_widget(__NAMESPACE__ . '\\ItreCallout');
});
